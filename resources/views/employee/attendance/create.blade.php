                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <span style="float:right" id='ct'></span>
                        </div>
                        <!-- /.card-header -->
                        ...
                        @endif
                            ...
                            <div class="card-footer" >
                                ...
                                @else
                                <button type="submit" class="btn btn-primary pull-right" style="font-size:1.2rem">
                                    Record Exit
                                </button>
                                @endif
                            </div>   
...
$(document).ready(function() {
    if ("geolocation" in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(position => {
            ...
            $.post("/hrms/public/employee/attendance/get-location", 
            {

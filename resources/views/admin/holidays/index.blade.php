            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="float:right; margin-bottom: 5px;">
                        <a href="{{ route('admin.holidays.create') }}"><button class="btn btn-info btn-sm"> Add Holidays</button></a>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <table class="table table-hover" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ route('admin.holidays.edit', $holiday->id) }}" class="btn btn-xs btn-warning">Edit</a>
                                            <button 

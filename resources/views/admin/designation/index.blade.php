...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">List of Designation</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="float:right; margin-bottom: 5px;">
                        <a href="{{ route('admin.designations.create') }}"><button class="btn btn-info btn-sm"> Add Designation</button></a>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <table class="table table-hover" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.designations.edit', $desig->id) }}" class="btn btn-xs btn-warning">Edit</a>
                                        ...
                                        <div class="modal-content">
                                            <div class="card card-danger">
                                                ...
                                                <div class="card-body text-center d-flex" style="justify-content: center">
                                                    ...
                                                    <form 
                                                    action="{{ route('admin.designations.destroy', $designations->get($i-1)->id) }}"
                                                    method="POST"
                                                    >
                                                    @csrf
                                                    @method('DELETE')
